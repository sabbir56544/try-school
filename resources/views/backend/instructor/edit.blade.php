            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h2><strong>Instructor</strong> Update </h2>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('instructor.update', $instructor->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group form-float">
                                ...
                                <input type="text" value="{{ $instructor->address }}" class="form-control" placeholder="Addres" id="address"
                                    name="address">
                            ...
                            <div class="form-group form-float">
                                ...
                                <textarea name="bio" class="input-field summernote" placeholder="{{ __('Biography') }}" cols="30" rows="10">{{$instructor->bio}}</textarea>
                                @if ($errors->has('bio'))
                            ...
                            <div class="form-group form-float mt-2">
                                ...
                                @endif
								<div>
									<img src="{{$instructor->image}}" height="4.5rem" width="4.5rem" alt="">
								</div>
                            </div>
