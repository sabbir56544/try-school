            ...
            <div class="tab-content">
              <div id="basic" class="container tab-pane active"><br>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                      <input type="text" class="input-field" name="first_name" placeholder="First Name" required="" value="">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                      <input type="text" class="input-field" name="last_name" placeholder="Last Name" required="" value="">
                    </div>
                </div>
