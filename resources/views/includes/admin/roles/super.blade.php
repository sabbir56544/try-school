  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#book" aria-expanded="true"
      ...
      <span>{{ __('Manage Book') }}</span></a>
    </a>
    <div id="book" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <a class="collapse-item" href="{{ route('admin.bookcategory.index') }}">{{ __('Book Category') }}</a>
        <a class="collapse-item" href="{{ route('admin.book.index') }}">{{ __('Book List') }}</a>
        <a class="collapse-item" href="{{ route('admin.bookorder.index') }}">{{ __('Order List') }}</a>
      </div>
    </div>
  </li>
