...
<!-- Mirrored from gambolthemes.net/html-items/cursus_main_demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Jun 2022 12:30:51 GMT -->
...
<head>
    ...
    <link href="{{ asset('assets/frontend/fonts.googleapis.com/cssccc8.css?family=Roboto:400,700,500') }}" rel='stylesheet'>
...
<body>
    ...
    <header class="header clearfix">
        ...
        <div class="main_logo" id="logo">
            ...
            <a href="index.html"><img class="logo-inverse" src="{{ asset('assets/frontend/images/ct_logo.svg') }}" alt=""></a>
        </div>
        ...
        <div class="header_right">
            <ul>
                <li>
                    <a href="#" class="upload_btn" title="Create New Course">Create New
                        Course</a>
                        <a href="{{ route('exhibitor.create') }}" class="upload_btn" title="Exibition Registration">Exibition Registration</a>
                        <a href="" class="upload_btn" title="Exibitions">Exibitions</a>
                </li>
                <li>
                ...
                <li class="ui dropdown">
                    <a href="#" class="opts_account" title="Account">
                        <img src="{{ asset('assets/frontend/images/hd_dp.jpg') }}" alt="">
                    </a>
                            ...
                            <div class="profile_link">
                                ...
                                <div class="pd_content">
                                    ...
                                    <span><a href="https://gambolthemes.net/cdn-cgi/l/email-protection"
                                            class="__cf_email__"
                                            data-cfemail="1275737f707d7e2b262152757f737b7e3c717d7f">[email&#160;protected]</a></span>
                                </div>
                            </div>
                                        ...
                                        <li>
                                            <a href="index.html">
                                                <div class="footer_logo">
                                                    <img src="{{ asset('assets/frontend/images/logo1.svg') }}" alt="">
                                                </div>
                                            </a>
                                        </li>
                                        <li>
    ...
    <script data-cfasync="false" src="{{ asset('assets/frontend/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js') }}"></script>
...
<!-- Mirrored from gambolthemes.net/html-items/cursus_main_demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Jun 2022 12:32:39 GMT -->
